...
export const SOURCES: Source[] = [
	...
	},
	{
		...
		title: "Nuclear Fuel Cycle Overview / Conversion and Deconversion",
		...
		kind: "institutional",
		note: "Process chemistry end to end: milling to U_{3}O_{8}, the U_{3}O_{8} -> UO_{2} -> UF_{4} -> UF_{6} conversion route, enrichment, and pellet fabrication. An industry body, so it is well-informed on process and not a neutral voice on nuclear policy — used here for the chemistry, not the politics.",
	},
	{
		id: "nps-oakridge",
